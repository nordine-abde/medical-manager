export const en = {
  ...
  careEvents: {
    ...
    export: {
      ...
      allSubtypes: "All available subtypes",
      dialogTitle: "Reports dossier",
      document: "Report",
      documentCount: "Attached documents",
      documentNotes: "Report notes",
      emptyDocument: "No report file is attached to this event.",
      emptyDocumentNotes: "No document notes recorded.",
      error: "Unable to generate the reports dossier.",
      eventCount: "Selected events",
      eventTypesLabel: "Event types",
      fileSize: "File size",
      filters: "Selection",
      generateAction: "Generate PDF",
      ...
      selectedEventTypes: "Event types",
      selectedSubtypes: "Subtypes",
      sourceEvent: "Care event",
      subtypesLabel: "Existing subtypes",
